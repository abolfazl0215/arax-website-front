...
export default function SpecialTours() {
  ...
  const { tours, toursLoading, fetchTours } = useDataStore();
  ...
  return (
    <div className="w-full px-[4vw] md:px-[10vw] py-[8vw] md:py-[4vw] bg-[#f1f5f9]">
      <div className="flex justify-between items-center mb-[4vw] md:mb-8">
        <div>
        ...
        <Swiper
          ...
          {displayedTours.map((tour) => (
            <SwiperSlide key={tour._id}>
              ...
              <Link href={`/${language.code || "en"}/tour/${tour._id}`} className="block rounded-2xl overflow-hidden transition-all duration-300 transform  border border-gray-100 bg-white">
                {/* Image */}
                ...
                <div className="p-4 md:p-6">
                  ...
                  {/* Book Button */}
                  <button className="w-full bg-gradient-to-r from-blue-500 to-cyan-500 text-white py-2.5 md:py-3 rounded-xl font-semibold hover:shadow-lg transition-all duration-300 hover:scale-105 text-sm md:text-base cursor-pointer">
                    Book Now
                  </button>
                </div>
              </Link>
